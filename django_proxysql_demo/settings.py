"""
Django settings for django_proxysql_demo project.
...
SECRET_KEY = 'ovf#0)0(r^^yks2e4_o0cspv$x&kw8@4*=k@_u2&p01q1(cxe8'
...
WSGI_APPLICATION = 'django_proxysql_demo.wsgi.application'
